        ...
        <div className="row">
          ...
          <div className="col-xs-12 col-sm-6 col-md-3">
              ...
              <ul className="social-footer2">
                <li className=""><a title="youtube" target="_blank" href="https://www.youtube.com/"><img alt="youtube"
                      width="30" height="30"
                ...
                <li className=""><a href="https://www.facebook.com/" target="_blank" title="Facebook"><img alt="Facebook"
                      width="30" height="30"
                ...
                <li className=""><a href="https://twitter.com" target="_blank" title="Twitter"><img alt="Twitter" width="30"
                      height="30"
                ...
                <li className=""><a title="instagram" target="_blank" href="https://www.instagram.com/"><img alt="instagram"
                      width="30" height="30"
                ...
                <li className="d-flex pt-4">
                  <img className="d-inline" src="img/creditcardicons.png" height="25" alt=""/>
                </li>
              </ul>
            </div>
          </div>
